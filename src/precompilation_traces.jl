...
precompile(Tuple{typeof(Base.promote_type), Type{GeometryExperiments.Translation{2, Float64}}, Type{GeometryExperiments.Transformation}})
precompile(Tuple{typeof(Base.getindex), Type{GeometryExperiments.Transformation}, GeometryExperiments.Translation{2, Float64}, GeometryExperiments.Scaling{2, Float64}, GeometryExperiments.Translation{2, Float64}})
...
precompile(Tuple{typeof(Base.grow_to!), Array{GeometryExperiments.Transformation, 1}, AbstractTrees.Leaves{GeometryExperiments.ComposedTransform{GeometryExperiments.ComposedTransform{GeometryExperiments.Translation{2, Float64}, GeometryExperiments.Scaling{2, Float64}}, GeometryExperiments.Translation{2, Float64}}}, AbstractTrees.LeavesState{AbstractTrees.ImplicitCursor{GeometryExperiments.Translation{2, Float64}, GeometryExperiments.ComposedTransform{GeometryExperiments.ComposedTransform{GeometryExperiments.Translation{2, Float64}, GeometryExperiments.Scaling{2, Float64}}, GeometryExperiments.Translation{2, Float64}}, Any}}})
...
precompile(Tuple{Type{Base.Broadcast.Broadcasted{Style, Axes, F, Args} where Args<:Tuple where F where Axes where Style<:Union{Nothing, Base.Broadcast.BroadcastStyle}}, Base.Broadcast.DefaultArrayStyle{1}, typeof(Base.:(==)), Tuple{Array{GeometryExperiments.Transformation, 1}, Array{GeometryExperiments.Transformation, 1}}})
precompile(Tuple{typeof(Base.Broadcast.materialize), Base.Broadcast.Broadcasted{Base.Broadcast.DefaultArrayStyle{1}, Nothing, typeof(Base.:(==)), Tuple{Array{GeometryExperiments.Transformation, 1}, Array{GeometryExperiments.Transformation, 1}}}})
